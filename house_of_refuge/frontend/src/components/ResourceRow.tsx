...
const MatchModal = ({showModal, handleClose, matchHandle, resource, activeSub}) => {
  ...
  type setSuccessType = false | (() => void);
  ...
  >
    <Modal.Body className={"text-center"}>
      <SubmissionRow activeHandler={undefined} isGroupCoordinator={undefined} sub={activeSub} isActive={true} readOnly={true} user={resource.owner || {}}/>
      <ResourceRow onMatch={undefined} user={undefined} activeSub={undefined} resource={resource} isExpanded={true} isCoordinator={false} compact={true}/>
    ...
    <Modal.Footer className={"justify-content-around"}>
      <Button variant="danger" onClick={() => setSuccess(toIgnore as any)}>
        Do wywalenia
      </Button>
